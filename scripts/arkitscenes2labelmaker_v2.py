...
def process_arkit(
    ...
    # depth_files = sorted(os.listdir(join(target_dir, 'depth')))
    # pose_files = sorted(os.listdir(join(target_dir, 'pose')))
    # intrinsic_files = sorted(os.listdir(join(target_dir, 'intrinsic')))
    #
    # # 筛选要保留的帧索引
