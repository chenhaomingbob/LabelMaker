...
for workspace in "$PARENT_DIR"/*/; do
    ...
    # --- 5. Mask3D ---
    # 注意: 这里使用了 '&&'，只有第一条命令成功后才会执行第二条
    echo "[INFO] 正在运行 Mask3D..."
